package com.github.tartaricacid.netmusicradio.client.gui;
...
public class CustomBigMegaphoneScreen extends Screen {
    ...
    private void openPresetPicker() {
        if (this.minecraft != null) {
            this.minecraft.setScreen(new com.github.tartaricacid.netmusicradio.client.RadioSearchScreen(this));
        }
    }
